# My Code – Arkwright, Lydia Koleosho
""" in this program, I have aimed to create a procrastination app that will distract
the user from their work and, in turn, make them work more
my idea is that if there is a solid line created between work and play, people
will lead more balanced, less stressed lives """
...
aiy.audio.say("Hi, " + myName + ". What accent would you like me to speak in today? I can speak with English, Spanish and French accents") 
